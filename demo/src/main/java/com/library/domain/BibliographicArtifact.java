...
public abstract class BibliographicArtifact {
    ...
    /**
     * Retrieves the owner of the bibliographic artifact.
     * @return The artifact owner.
     */
    ...
    /**
     * Sets the owner of the bibliographic artifact.
     * @param owner The artifact owner to be set.
     */
