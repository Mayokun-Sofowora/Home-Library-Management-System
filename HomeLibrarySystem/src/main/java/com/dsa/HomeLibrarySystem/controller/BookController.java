...
public class BookController {
    ...
    public ResponseEntity<Void> addReview(@PathVariable Long id, @RequestBody BibliographicArtifact.Review review) {
        bookService.addReview(id, review.getContent(), review.getReviewer());
