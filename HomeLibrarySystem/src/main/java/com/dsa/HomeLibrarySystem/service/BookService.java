...
public class BookService {
    ...
    @Autowired
    public BookService(BookRepository bookRepository, BookshelfLocationService bookshelfLocationService, AuthorRepository authorRepository, AuthorService authorService) {
