...
<head>
	...
	<title>Home - Welcome to Home Library</title>
        ...
        <div class="mt-2 mt-lg-0 collapse navbar-collapse justify-content-md-center" id="navbarHeader">
            <ul class="navbar-nav">
                ...
                <li class="nav-item active mx-4">
					<a class="btn btn-primary" href="locations.jsp">Locations</a>
				</li>
				<li class="nav-item mx-4">
					<a class="btn btn-primary" href="about.jsp">About</a>
				</li>
				<li class="nav-item mx-4">
					<a class="btn btn-primary" href="contact.jsp">Contact</a>
				</li>
				<li class="nav-item mx-4">
					<a class="btn btn-primary" href="search.jsp">Filter Search</a>
                </li>
            </ul>
            <form class="form-inline my-2 mx-4 my-lg-0 pl-4" action="@{/search}" method="get">
                <div class="input-group">
                    <input class="form-control" type="text" id="headerSearch" placeholder="Search" aria-label="Search" name="query">
                    <button class="btn btn-outline-secondary header-search-button-custom" type="submit">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#ffffff" class="bi bi-search" viewBox="0 0 16 16"><path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001q.044.06.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1 1 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0"/></svg>
                    </button>
                </div>
            </form>
		    <ul class="navbar-nav">
				<li class="nav-item mx-4">
					<a class="btn btn-secondary" href="login.jsp">Log Out</a>
                </li>
            </ul>
...
<div id="books-container">
    ...
    <p>Explore our collection of books <a href="${pageContext.request.contextPath}/books">here</a>.</p>
</div>
...
<footer class="border-top footer text-muted bg-light text-center py-4">
    <div class="container">
        &copy; 2024 - Home Library - <a asp-area="" asp-controller="Home" asp-action="Privacy">Privacy</a>
<%--        <p class="mb-0">Home Library &copy; 2024</p>--%>
    </div>
</footer>
</body>
</html>
