...
<head>
    ...
    <title>About - Welcome to Home Library</title>
        ...
        <div class="mt-2 mt-lg-0 collapse navbar-collapse justify-content-md-center" id="navbarHeader">
            ...
            <form class="form-inline my-2 mx-4 my-lg-0 pl-4">
                <div class="input-group">
                    <input class="form-control" type="text" id="headerSearch" placeholder="Search" aria-label="Search">
                    <button class="btn btn-outline-secondary header-search-button-custom" type="button" onclick="searchBooks()">
...
<div class="container">
    <div class="row mt-5">
        <div class="col">
            <h2>About</h2>
            <p>Welcome to Home Library! Our system is designed for book lovers who enjoy reading and collecting books and journals. We believe that every bibliographic artifact holds value and should be cherished.</p>
            <p>With our system, you can easily register your entire book collection, including the location of each book on your shelves. You can also lend books and journals to your friends who are also system users, and all lending activities are recorded for easy management.</p>
            <p>Our system enables users to search through the global collection of the entire community. You can reserve books, borrow them, and return them .</p>
        </div>
    </div>
</div>
