...
<html lang="en">
    ...
    <body>
        <header>
            <nav class="navbar navbar-expand-lg navbar-light rounded">
                ...
                <div class="mt-2 mt-lg-0 collapse navbar-collapse justify-content-md-center" id="navbarHeader">
                    <ul class="navbar-nav">
                        <li class="nav-item dropdown mx-4">
                            ...
                            <div class="dropdown-menu p-0 multi-column-dropdown" aria-labelledby="dropdownGenres">
                                <a class="dropdown-item" href="/searchArtifact?genre=Classics">Classics</a>
                                <a class="dropdown-item" href="/searchArtifact?genre=Romance">Romance</a>
                                <a class="dropdown-item" href="/searchArtifact?genre=Fiction">Fiction</a>
                                <a class="dropdown-item" href="/searchArtifact?genre=Detective">Detective</a>
                                <a class="dropdown-item" href="/searchArtifact?genre=Documentary">Documentary</a>
                                <a class="dropdown-item" href="/searchArtifact?genre=Biographies">Biographies</a>
                                <a class="dropdown-item" href="/searchArtifact?genre=History">History</a>
                                <a class="dropdown-item" href="/searchArtifact?genre=Research">Research</a>
                                <a class="dropdown-item" href="/searchArtifact?genre=Educational">Educational</a>
                                <a class="dropdown-item" href="/searchArtifact?genre=Comics">Comics</a>
                                <a class="dropdown-item" href="/searchArtifact?genre=Manga">Manga</a>
                                <a class="dropdown-item" href="/searchArtifact?genre=For children">For children</a>
                                <a class="dropdown-item" href="/searchArtifact?genre=Religion">Religion</a>
                                <a class="dropdown-item" href="/searchArtifact?genre=Erotic literature">Erotic literature</a>
                                <a class="dropdown-item" href="/searchArtifact?genre=More...">More...</a>
                            </div>
                        </li>
                    ...
                    <form class="form-inline my-2 mx-4 my-lg-0 pl-4" action="/search" method="GET">
                        <div class="input-group">
                            <input class="form-control" type="text" id="headerSearch" name='q' placeholder="Search" aria-label="Search">
        ...
        <div class="container d-flex justify-content-center mt-3">
            <form class="needs-validation" style="max-width: 650px;" novalidate="" action="/searchArtifact" method="GET">
                <div class="row g-3">
                    <div class="col-12">
                        <h3>Search artifact:</h3>
                    ...
                    <div class="col-md-3 col-6">
                        <div class="input-group">
                            <input type="text" class="form-control" id="yearFrom" placeholder="Year From">
                        </div>
                    </div>
                    <div class="col-md-3 col-6">
                        <div class="input-group">
                            <input type="text" class="form-control" id="yearTo" placeholder="Year To">
                        </div>
                    </div>
                </div>
                <div class="my-2 form-check">
                    <input type="checkbox" class="form-check-input" id="isCensoredIncluded">
                    <label class="form-check-label" >Include censored books<span style="color: red;"></span></label>
                </div>
                <div class="d-flex justify-content-center advanced-search-button-custom">
                    <button class="w-50 btn btn-primary btn-lg" type="submit">Search</button>
                </div>
            </form>
