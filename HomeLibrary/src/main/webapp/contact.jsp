...
<head>
    ...
    <title>Contact - Welcome to Home Library</title>
    ...
    <header>
        ...
        <div class="text-center p-3">
            ...
            <ul class="list-unstyled">
                <li>Carlota Lueje - cl900928@student.polsl.pl</li>
                <li>Eva Álvarez - ea900769@student.polsl.pl</li>
                <li>Carla López - cl900772@student.polsl.pl</li>
                <li>Josevin Siby - js304279@student.polsl.pl</li>
                <li>Ahmad Gamidi - ag304351@student.polsl.pl</li>
                <li>Oluwamayokun Sofowora - oluwsof295@student.polsl.pl</li>
            </ul>
        </div>
